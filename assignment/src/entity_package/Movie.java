...
public class Movie {
	...
	private LinkListGenric<Genres> genres;
	private String homepagehomepage;
	private LinkListGenric<KeyWord> keywords;
	private String originalLanguage;
	private String originalTitle;
	private String overview;
	private String popularity;
	private LinkListGenric<ProductionCompanies> productionCompanies;
	private LinkListGenric<ProductionCountries> productionCountries;
	private String releaseDate;
	private long revenue;
	private String runtime;
	private LinkListGenric<SpokenLanguages> spokenLanguages;
	 ...
	 * @return the genres
	 */
	public LinkListGenric<Genres> getGenres() {
		return genres;
	}
	/**
	 * @param genres the genres to set
	 */
	public void setGenres(LinkListGenric<Genres> genres) {
		this.genres = genres;
	}
	/**
	 ...
	 * @return the keywords
	 */
	public LinkListGenric<KeyWord> getKeywords() {
		return keywords;
	}
	/**
	 * @param keywords the keywords to set
	 */
	public void setKeywords(LinkListGenric<KeyWord> keywords) {
	 ...
	 */
	public LinkListGenric<ProductionCompanies> getProductionCompanies() {
		return productionCompanies;
	}
	/**
	 * @param productionCompanies the productionCompanies to set
	 */
	public void setProductionCompanies(LinkListGenric<ProductionCompanies> productionCompanies) {
		this.productionCompanies = productionCompanies;
	}
	/**
	 * @return the productionCountries
	 */
	public LinkListGenric<ProductionCountries> getProductionCountries() {
		return productionCountries;
	}
	/**
	 * @param productionCountries the productionCountries to set
	 */
	public void setProductionCountries(LinkListGenric<ProductionCountries> productionCountries) {
	 ...
	 */
	public LinkListGenric<SpokenLanguages> getSpokenLanguages() {
		return spokenLanguages;
	}
	/**
	 * @param spokenLanguages the spokenLanguages to set
	 */
	public void setSpokenLanguages(LinkListGenric<SpokenLanguages> spokenLanguages) {
	 ...
	 */
	public LinkListGenric<ProductionCountries> getProduction_countries() {
		return productionCountries;
	}
	/**
	 * @param production_countries the production_countries to set
	 */
	public void setProduction_countries(LinkListGenric<ProductionCountries> production_countries) {
	 ...
	 */
	public LinkListGenric<SpokenLanguages> getSpoken_languages() {
		return spokenLanguages;
	}
	/**
	 * @param spoken_languages the spoken_languages to set
	 */
	public void setSpoken_languages(LinkListGenric<SpokenLanguages> spoken_languages) {
